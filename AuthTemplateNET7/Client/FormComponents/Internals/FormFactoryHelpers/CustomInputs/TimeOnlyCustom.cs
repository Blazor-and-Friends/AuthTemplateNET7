...
//added
public class TimeOnlyCustom<TValue> : InputBase<TValue>
{
    ...
    protected override string FormatValueAsString(TValue value)
    {
        return value switch
        {
            TimeOnly timeOnlyValue => BindConverter.FormatValue(timeOnlyValue, TIME_FORMAT, CultureInfo.InvariantCulture),
            _ => string.Empty
        };
    }
